...
router.get('/', function (req, res) {
  res.render('index', { title: 'Dumbell App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'Dumbell App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Dumbell App Login', user: req.user });
});
